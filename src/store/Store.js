...
export const $treemap = atom({
  children: [
    ...
    { key: "Produire", color: "yellow", percentage: 25, keywords: ["test", "toto"] },
    { key: "Développer", color: "green", percentage: 25, keywords: ["Competence"] },
    { key: "Entreprendre", color: "blue", percentage: 25, keywords: ["a", "b", "c"] },
  ]}
);
